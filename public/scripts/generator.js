...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const isPcAdv    = page === "pc-advanced.html";
    // If we’re NOT on any of the four generator pages, bail out
    if (!isNpcQuick && !isPcQuick && !isNpcAdv && !isPcAdv) {
      console.log("⏭ Not a generator page, skipping generator.js");
      return;
    }  
